    ...
    while(simbolo < len(frase)):
        ...
        #Palabras reservadas o ID's
            ...
            if(frase[simbolo] in palabra):
                ...
                final+=reserv(word,fil,columna+1)
                word = ''
                state = 0
            elif(frase[simbolo] in malasletras):
                final+=lexema('id',word,fil,columna+1)
                fil+=len(word)
                final+=error(fil, columna+1)
                bandera = 1
                break;
        ...
        #4 caracter bien
            ...
            if(frase[simbolo]=="'"):
                word+=frase[simbolo]
                simbolo += 1
                final+=lexema(tk_dato['caracter'],word,fil,columna+1)
                word=''
                state = 0
            else:
                final+=error(fil, columna+1)
        ...
        #6 String
            ...
            if(frase[simbolo] in caracter):
                ...
                word+=frase[simbolo]
                simbolo += 1
                final+=lexema(tk_dato['cadena'], word,fil,columna+1)
                state = 0
                word=''
            else:
                final+=error(fil, columna+1)
        ...
        #8 Entero o Double - \n
            ...
            if(frase[simbolo] in numero):
                ...
                final+=lexema(tk_dato['int'], word,fil,columna+1)
                word = ''
                state = 0
        #9 INT - \n
        elif(state == 8):
        ...
        #10 Verificación Double
            ...
            if(frase[simbolo] in numero):
                ...
                final+=lexema(tk_dato['real'], word,fil,columna+1)
                word = ''
                state = 0
        #11  Comentarios
        elif(state == 10):
            if(frase[simbolo] == '/'):
                ...
                word += '/'
                final+=token(tk_sim[word],fil,columna+1)
                word=''
                state = 0
        #12 // Comentarios //
        elif(state == 11):
